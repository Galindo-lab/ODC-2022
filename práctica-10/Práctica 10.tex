...
\hline
\end{tabular}
\end{center}\footnotetext[1]{\label{orgbf97686}al terminar el servicio el valor se reemmplaza con el numero de caracteres capturados}\footnotetext[2]{\label{org1a72989}0: Entrada estándar o teclado.}\footnotetext[3]{\label{org5f398c0}1: salida estándar o terminal.}\footnotetext[4]{\label{org68a90d6}Más informacion: \url{https://es.wikipedia.org/wiki/Int\_80h}}
